...
topic: *** escolha para seu botão<BR>
Wifi da sala:  ifsp-ibge-1<BR>
senha: ifspcatanduva<BR>

Trabalhos de anos anteriores: https://github.com/mchavesferreira/mcr/tree/main/trabalho
...
## Estacao meterologica em Catanduva 

host:  broker.hivemq.com<BR>

Topic= mcr/estacao<BR>

path Json= $.temperatura<BR>

path Json= $.umidade<BR>
