...
* correção Marcos Chaves Novembro/2022
...
// device names
String Device_1_Name = "luz vermelha";
String Device_2_Name = "luz verde";
String Device_3_Name = "luz azul";
String Device_4_Name = "luz amarela";

// device_function names
String Dev_Func_1_Name = "cama";
String Dev_Func_2_Name = "cadeira";
String Dev_Func_3_Name = "todos dispositivos";
...
// WiFi Credentials
const char* ssid = "Isaweb_5";
const char* password = "aula#mcr2022";
...
void setup()
{
  ...
  ledcAttachPin(RelayPin1, ledChannel);
...
void device1Changed(uint8_t brightness){
  ...
  else
  {
    ...
    ledcWrite(RelayPin1, brightness);
